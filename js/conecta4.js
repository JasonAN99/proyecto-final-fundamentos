...
function ganador(tablero, jugador, fila, columna) {
  for (let i = 0; i < matriz.length - 3; i++) {
    for (let j = 0; j < matriz.length; j++) {
      if (matriz[i + 3][j] === 1 && matriz[i + 2][j] === 1 && matriz[i + 1][j] === 1 && matriz[i][j] === 1) {
        return true;
      }
      if (matriz[i + 3][j] === 2 && matriz[i + 2][j] === 2 && matriz[i + 1][j] === 2 && matriz[i][j] === 2) {
        return true;
      }
    }
  }
  for (let i = 0; i < matriz.length; i++) {
    for (let j = 0; j < matriz.length - 3; j++) {
      if (matriz[i][j + 3] === 1 && matriz[i][j + 2] === 1 && matriz[i][j + 1] === 1 && matriz[i][j] === 1) {
        return true;
      }
      if (matriz[i][j + 3] === 2 && matriz[i][j + 2] === 2 && matriz[i][j + 1] === 2 && matriz[i][j] === 2) {
        return true;
      }
    }
  }
  for (let i = 0; i < matriz.length - 3; i++) {
    for (let j = 0; j < matriz.length - 3; j++) {
      if (matriz[i + 3][j + 3] === 1 && matriz[i + 2][j + 2] === 1 && matriz[i + 1][j + 1] === 1 && matriz[i][j] === 1) {
        return true;
      }
      if (matriz[i + 3][j + 3] === 2 && matriz[i + 2][j + 2] === 2 && matriz[i + 1][j + 1] === 2 && matriz[i][j] === 2) {
        return true;
      }
      if (matriz[i][j + 3] === 1 && matriz[i + 1][j + 2] === 1 && matriz[i + 2][j + 1] === 1 && matriz[i + 3][j] === 1) {
        return true;
      }
      if (matriz[i][j + 3] === 2 && matriz[i + 1][j + 2] === 2 && matriz[i + 2][j + 1] === 2 && matriz[i + 3][j] === 2) {
        return true;
      }
    }
  }
